            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6" style="text-align: right">
                        <a href="{{ route('homework_teacher.deletedList') }}" class="btn btn-primary">Show Deleted Homeworks</a>
                        <a href="{{ route('homework_teacher.create') }}" class="btn btn-primary">Add New Homework</a>
                    </div>
                                    ...
                                    <tbody>
                                        @forelse ($data['getRecord'] as $value)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('homework_teacher.edit', ['id' => $value->id]) }}"
                                                        class="btn btn-primary">Edit</a>
                                                        <form action="{{ route('homework_teacher.destroy', ['id' => $value->id]) }}" method="post" style="display:inline;">
                                                            @csrf
                                                            @method('delete')
