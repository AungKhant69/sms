                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <form method="POST" action="{{ route('admin_teacher.update', $data['getRecord']->id) }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="form-control" required name="gender">
                                                ...
                                                <option
                                                    {{ old('gender', $data['getRecord']->gender) == 'Male' ? 'selected' : '' }}
                                                    value="Male">Male</option>
                                                <option
                                                    {{ old('gender', $data['getRecord']->gender) == 'Female' ? 'selected' : '' }}
